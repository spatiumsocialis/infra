...
type (
	...
	MessageHandler func(s *common.Service, m *sarama.ConsumerMessage) error
...
func NewConsumer(s *common.Service, topicHandlerMap map[string]MessageHandler) {
	verifyConsumerFlags()
